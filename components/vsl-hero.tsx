      ...
      <div className="relative z-10 flex min-h-screen flex-col items-center justify-center px-4 py-12 sm:px-6 md:py-16 lg:px-8">
        <div className="mx-auto max-w-4xl space-y-8 text-center">
          ...
          <h1 className="text-balance text-2xl font-bold leading-tight text-[#4E4E4E] sm:text-3xl md:text-4xl lg:text-5xl">
            Você está cansada de começar o ano prometendo que{" "}
          ...
          >
            <a
              ...
              className="group inline-flex items-center justify-center gap-2 rounded-full bg-gradient-to-r from-[#22C55E] to-[#16A34A] px-8 py-4 text-base font-semibold text-white shadow-lg shadow-[#22C55E]/40 transition-all duration-300 hover:scale-105 hover:shadow-xl hover:shadow-[#22C55E]/50 sm:px-10 sm:py-5 sm:text-lg"
            >
